...
accept Just a Flesh Wound##30148 |goto The Jade Forest 57.50,44.70 |only if skill("First Aid")>=525
...
step
talk Jenova Longeye##58413
turnin Just a Flesh Wound##30148 |goto The Jade Forest 57.50,44.70 |only if skill("First Aid")>=525
...
step
talk Okrut Dragonwaste##66638
turnin Okrut Dragonwaste##31933 |goto Dragonblight 59.00,77.00
step
...
step
talk Major Payne##66675
turnin Grand Master Payne##31935 |goto Icecrown 77.40,19.60
step
talk Gutretch##66639
...
He can also be found around this area |goto Kun-Lai Summit 44.70,52.40
step
talk Courageous Yon##66738
...
Select _"I need a flight to the border of Nagrand."_ |goto Frostwall/0 45.80,50.80 < 5
_Go up_ the hill |goto Nagrand D/0 89.40,70.50
...
step
_Follow_ the path |goto Nagrand D/0 84.80,66.00 < 20 |only if walking
_Continue_ along the cobblestone path |goto Nagrand D/0 80.90,56.50 < 20 |only if walking
_Go straight_ through the crossroads |goto Nagrand D/0 81.90,53.30 < 20 |only if walking
talk Thrall##80003
...
step
talk Tal##82346
fpath Wor'var |goto Nagrand D/0 83.30,44.70
step
talk Elathriel Sunstriker##82345
home Wor'var |goto Nagrand D/0 82.60,45.40
step
...
stickystart "ST1"
step
_Swim over_ the lake and run up the hill |goto Nagrand D/0 85.10,45.00 < 20 |only if walking
accept Bonus Objective: Hemet's Happy Hunting Grounds##35379 |goto Nagrand D/0 88.10,48.60 |only if not haveq(35379)
kill Lupe##82205 |q Bonus Objective: Hemet's Happy Hunting Grounds##35379/2 |goto Nagrand D/0 87.60,45.60
kill Loup##82209 |q Bonus Objective: Hemet's Happy Hunting Grounds##35379/3 |goto Nagrand D/0 87.60,45.60
step
accept Bonus Objective: Hemet's Happy Hunting Grounds##35379 |goto Nagrand D/0 88.10,48.60 |only if not haveq(35379)
kill Big Pete##123 |q Bonus Objective: Hemet's Happy Hunting Grounds##35379/4 |goto Nagrand D/0 88.70,43.90
step
label "ST1"
accept Bonus Objective: Hemet's Happy Hunting Grounds##35379 |goto Nagrand D/0 88.10,48.60 |only if not haveq(35379)
kill 15 Nagrand Prowler##81902 |q Bonus Objective: Hemet's Happy Hunting Grounds##35379/1 |goto Nagrand D/0 87.13,49.16
step
_Travel up_ the dirt road and through the gate |goto Nagrand D/0 87.00,52.60 < 20 |only if walking
...
There should be one chest in this building |goto Nagrand D/0 84.80,55.50 < 20
Check the Chests in this building, there should be 2 |goto Nagrand D/0 85.80,56.90 < 20
There should be a single chest in here |goto Nagrand D/0 85.50,53.00 < 20
...
step
_Enter_ the building |goto Nagrand D/0 85.50,55.00 < 10 |walk
talk Lantresor of the Blade##80161
...
step
_Enter_ the cave |goto Nagrand D/0 88.00,55.50 < 20 |walk
...
step
_Leave_ the cave |goto Nagrand D/10 30.50,15.70 < 15 |walk
_Pass_ through the gates |goto Nagrand D/0 87.00,52.50 < 20 |only if walking
_Continue_ traveling between the cliffs |goto Nagrand D/0 86.00,51.50 < 20 |only if walking
_Follow_ the path |goto Nagrand D/0 84.30,49.30 < 15 |only if walking
talk Thrall##80003
...
Choose between Corral & Tankworks |q A Choice to Make##34899/1 |goto Nagrand D 83.00,44.10
step
...
path	79.60,44.00	80.70,42.90	79.80,40.50
path	79.50,37.60	77.60,36.10	75.40,37.50
path	74.70,41.00	72.70,42.20	73.20,48.40
path	73.70,52.10	75.10,54.30	78.00,55.40
path	80.90,52.80	80.90,49.60	81.00,46.10
...
step
talk Meatgut##82727
accept Meatgut Needs Bones##35928 |instant |repeatable |goto Nagrand D/0 78.30,52.40
...
step
talk Shazdar##49737
buy Imported Supplies##68689 |goto Orgrimmar 56.80,62.60
step
