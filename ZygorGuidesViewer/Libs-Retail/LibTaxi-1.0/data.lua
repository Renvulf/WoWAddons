...
[2274]={
	...
	['Tazavesh']={ 
		...
		{name="Tazavesh",faction="B",npc="Phase Conduit",npcid=234692,x=46.78,y=56.79,taxioperator="phaseconduit",taxinodeID=3145,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
	},	
	['K\'aresh']={ 
		-- NEUTRAL --
		...
		-- NEUTRAL --
		{name="Hosaas' Rest",faction="B",npc="Phase Conduit",npcid=234701,x=53.85,y=63.60,taxioperator="phaseconduit",taxinodeID=3164,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="Ruins of Yaathron",faction="B",npc="Phase Conduit",npcid=234722,x=51.38,y=67.14,taxioperator="phaseconduit",taxinodeID=3163,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="The Oasis",faction="B",npc="Phase Conduit",npcid=234718,x=75.88,y=33.10,taxioperator="phaseconduit",taxinodeID=3146,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="Shan'dorah",faction="B",npc="Phase Conduit",npcid=234721,x=60.21,y=29.05,taxioperator="phaseconduit",taxinodeID=3147,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="Overlook Zo'Shuul",faction="B",npc="Phase Conduit",npcid=234724,x=50.41,y=36.40,taxioperator="phaseconduit",taxinodeID=3157,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="Shadow Point",faction="B",npc="Phase Conduit",npcid=234719,x=45.21,y=23.91,taxioperator="phaseconduit",taxinodeID=3155,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="Naakroa",faction="B",npc="Phase Conduit",npcid=234692,x=58.90,y=57.89,taxioperator="phaseconduit",taxinodeID=3160,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="Serrated Peaks",faction="B",npc="Phase Conduit",npcid=234701,x=51.21,y=48.57,taxioperator="phaseconduit",taxinodeID=3156,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="Lunnall River",faction="B",npc="Phase Conduit",npcid=234722,x=65.44,y=47.98,taxioperator="phaseconduit",taxinodeID=3158,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="North Sufaad",faction="B",npc="Phase Conduit",npcid=234718,x=77.17,y=48.93,taxioperator="phaseconduit",taxinodeID=3159,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="Fracture of Laacuna",faction="B",npc="Phase Conduit",npcid=234721,x=56.20,y=21.51,taxioperator="phaseconduit",taxinodeID=3161,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="Untethered Space",faction="B",npc="Phase Conduit",npcid=234724,x=53.92,y=26.75,taxioperator="phaseconduit",taxinodeID=3162,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(1214374) end},
	},
