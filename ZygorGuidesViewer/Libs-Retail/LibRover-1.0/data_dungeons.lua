...
data.basenodes.DungeonEntrances = --[[LIBROVER]] {
	...
	-- DELVE ENTRANCE/EXITS
			...
			--Archival Assault--
			"K'aresh/0 55.09,48.07 -x- Archival Assault/3 39.17,88.46 {title_atob:Click Enter Delve} {title_btoa:Click Leave Delve}",
}
...
data.basenodes.DungeonFloors = --[[LIBROVER]] {
	...
	--Raids
		...
		["Archival Assault"] = {
			...
			--"Archival Assault/3 32.07,82.25 -x- Archival Assault/2 26.41,76.71 {title_atob:Jump down} {title_btoa:Click the Explorers' League Rope}",
